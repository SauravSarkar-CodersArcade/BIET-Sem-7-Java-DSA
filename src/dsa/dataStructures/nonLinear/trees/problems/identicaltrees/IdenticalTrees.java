package dsa.dataStructures.nonLinear.trees.problems.identicaltrees;
class TreeNode{
    int data;
    TreeNode left;
    TreeNode right;
...
public class IdenticalTrees {
    public static boolean areIdentical(TreeNode t1, TreeNode t2){
        ...
        // If the data of the nodes is not matching
        if(t1.data != t2.data){
            return false;
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(areIdentical(t1,t2) ? "Identical" :
                "Not Identical");
        System.out.println(areIdentical(t3,t4) ? "Identical" :
                "Not Identical");
    }
}
